...
export default function WhatsAppSticky() {
  return (
    ...
    >
      ...
      {/* Tooltip */}
      <div className="absolute right-full mr-4 bg-white text-forest text-xs font-bold px-3 py-2 rounded-lg shadow-xl opacity-0 group-hover:opacity-100 pointer-events-none transition-opacity whitespace-nowrap border border-border hidden md:block">
        Chat with us
      </div>
    </motion.a>
  );
